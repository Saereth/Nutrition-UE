package com.breakinblocks.nutrition.potions;
...
public class ModPotions {
    ...
    public static void createPotions() {
        ...
        toughness.registerPotionAttributeModifier(SharedMonsterAttributes.MAX_HEALTH, TOUGHNESS_HEALTH.toString(), 0D,
                0);
        toughness.registerPotionAttributeModifier(SharedMonsterAttributes.ARMOR_TOUGHNESS, TOUGHNESS_ARMOR.toString(),
                0D, 0);
        toughness.registerPotionAttributeModifier(SharedMonsterAttributes.ATTACK_SPEED,
                TOUGHNESS_ATTACK_SPEED.toString(), 0D, 0);
        ...
        nourished.registerPotionAttributeModifier(SharedMonsterAttributes.MAX_HEALTH, NOURISHMENT_HEALTH.toString(), 0D,
                0);

        // Malnourished
        malnourished = new PotionMalnourished(true,
        ...
        malnourished.registerPotionAttributeModifier(SharedMonsterAttributes.MAX_HEALTH,
                MALNOURISHMENT_HEALTH.toString(), 0D, 0);
    }
}

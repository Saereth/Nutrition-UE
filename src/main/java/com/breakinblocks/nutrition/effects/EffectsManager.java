...
public class EffectsManager {
    ...
    public static void reapplyEffects(EntityPlayer player) {
        ...
        for (Effect effect : effects) {
            boolean ambient = (effect.particles == Effect.ParticleVisibility.TRANSLUCENT); // Determine if particles
                                                                                           // should be shown, and what
                                                                                           // strength
            boolean showParticles = (effect.particles == Effect.ParticleVisibility.TRANSLUCENT ||
                    effect.particles == Effect.ParticleVisibility.OPAQUE);

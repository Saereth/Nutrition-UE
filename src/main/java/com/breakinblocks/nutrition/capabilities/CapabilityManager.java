package com.breakinblocks.nutrition.capabilities;
...
public class CapabilityManager {
    ...
    public static void register() {
        net.minecraftforge.common.capabilities.CapabilityManager.INSTANCE.register(INutrientManager.class,
                new Storage(), SimpleImpl::new);
    }
    ...
    public static class Storage implements Capability.IStorage<INutrientManager> {
        ...
        @Override
        public void readNBT(Capability<INutrientManager> capability, INutrientManager instance, EnumFacing side,
                            NBTBase nbt) {

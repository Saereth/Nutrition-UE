...
public record TierCondition(CombineMode combine,
                            ...
                            Map<ResourceLocation, RangeSpec> perNutrient) {
    ...
    public static final Codec<TierCondition> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            Codec.unboundedMap(ResourceLocation.CODEC, RangeSpec.CODEC).optionalFieldOf("per_nutrient", Map.of()).forGetter(TierCondition::perNutrient)

...
public final class DefaultNutrients {
    ...
    public static void bootstrap(BootstrapContext<NutrientDefinition> ctx) {
        ctx.register(FRUIT, new NutrientDefinition(
                new ItemStack(Items.APPLE), 0xCF3531, 1.0f, true, 50.0f, Optional.empty()));
        ctx.register(GRAIN, new NutrientDefinition(
                new ItemStack(Items.BREAD), 0xF4D92E, 1.0f, true, 50.0f, Optional.empty()));
        ctx.register(PROTEIN, new NutrientDefinition(
                new ItemStack(Items.COOKED_BEEF), 0xA0522D, 1.0f, true, 50.0f, Optional.empty()));
        ctx.register(VEGETABLE, new NutrientDefinition(
                new ItemStack(Items.CARROT), 0x72DD5A, 1.0f, true, 50.0f, Optional.empty()));
        ctx.register(DAIRY, new NutrientDefinition(
                new ItemStack(Items.MILK_BUCKET), 0xFFF8E7, 1.0f, true, 50.0f, Optional.empty()));
    }
